...
class _EmployeeCameraScreenState extends State<EmployeeCameraScreen>
  ...
  void _initialiseControllers() {
    ...
    _exposureAnim = CurvedAnimation(
        parent: _exposureAnimController, curve: Curves.easeInCubic);
  }
          ...
          child: InkWell(
            onTap: () {
              if (selectedType == videoText) {
                ...
                Future.delayed(
                    const Duration(milliseconds: 500), takePicture);
              }
            },
            child: Container(
              ...
              onTap: () {
                ...
                Navigator.of(context)
                  ...
                  builder: (_) =>
                    ...
                    .then((value) {
                  if (mounted && cameras.isNotEmpty) {
                    _safeInitCamera(frontCamera && cameras.length > 1
                        ? cameras[1]
                        : cameras[0]);
                  }
      ...
      child: ClipRect(
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          Text(
            ...
            style: TextStyle(
                color: Colors.white, fontSize: size.width * numD03),
          ),
          SliderTheme(
